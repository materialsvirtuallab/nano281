...
\begin{frame}{What is Data Science?}
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{lectures/slides_tex/figures/datascience.png}    \end{figure}
\end{frame}

\begin{frame}{The Data Age}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{lectures/slides_tex/figures/worldwidedatacreation.png}
    \end{figure}
\end{frame}
...
\begin{figure}
        \centering
        \includegraphics[width=0.4\textwidth]{lectures/slides_tex/figures/icsd.png}
        \caption{ICSD: $\sim$200,000 crystals
}
    \end{figure}
    \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{lectures/slides_tex/figures/cod.png}
...
\column{0.5\textwidth}
    \begin{figure}
        \centering
        \includegraphics[width=0.4\textwidth]{lectures/slides_tex/figures/pdb.png}
        \caption{Protein data bank}
    \end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{lectures/slides_tex/figures/csd.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.45\textwidth]{lectures/slides_tex/figures/handbook_of_condensed_matter.jpg}
...
\column{0.5\textwidth}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{lectures/slides_tex/figures/supercon.png}
...
\begin{frame}{First Principles Materials Computations}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{lectures/slides_tex/figures/computational_materials_science.png}
    \end{figure}
\end{frame}
...
\begin{figure}
        \centering
        \includegraphics[width=\textwidth]{lectures/slides_tex/figures/reliability_of_dft.png}
    \end{figure}
\column{0.5\textwidth}
    \begin{figure}
        \centering
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{lectures/slides_tex/figures/mgi.png}
    \includegraphics[width=0.25\textwidth]{lectures/slides_tex/figures/doe_mp.png}
\end{figure}
\includegraphics[width=0.1\textwidth]{lectures/slides_tex/figures/mp_logo.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.40\textwidth]{lectures/slides_tex/figures/mp_image1.png}
    \includegraphics[width=0.20\textwidth]{lectures/slides_tex/figures/mp_image2.png}
\end{figure}
\end{frame}
...
\column{0.5\textwidth}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{lectures/slides_tex/figures/ml.png}
    \end{figure}
\column{0.5\textwidth}
\begin{figure}
        \centering
        \includegraphics[width=0.49\textwidth]{lectures/slides_tex/figures/waymo.png}
        \includegraphics[width=0.49\textwidth]{lectures/slides_tex/figures/alphago.jpeg}
        \includegraphics[width=0.49\textwidth]{lectures/slides_tex/figures/netflixrec.png}
    \end{figure}
\end{columns}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{lectures/slides_tex/figures/materials_ml_workflow.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Compositional features}
    ...
    \begin{columns}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{lectures/slides_tex/figures/compositional_features.png}
            \caption{Meredig et al. (2014) Phys. Rev. B89, 094104}
        \end{figure}
        \column{0.75\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.49\textwidth]{lectures/slides_tex/figures/elemnet.png}
            \includegraphics[width=0.49\textwidth]{lectures/slides_tex/figures/compositional_cnn.png}
...
\begin{frame}{Structural features}
    \begin{columns}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{lectures/slides_tex/figures/fragments_gb.png}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{lectures/slides_tex/figures/cgcnn.png}
