...
\begin{frame}{Boosting as a Forward Stagewise Additive Modeling}
    \begin{itemize}
        ...
        \item This approach is ``greedy'' in that it seeks to maximally reduce the loss at each step, i.e., steepest descent.
        \item In gradient boosting, one fits the tree to the negative gradient values by  least squares.
