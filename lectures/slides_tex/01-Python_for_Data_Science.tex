...
\begin{frame}[fragile]{Google Colab Demo}
    \begin{itemize}
        ...
        \begin{figure}
            \centering
            \includegraphics[height=0.25\textwidth]{lectures/slides_tex/GoogleColab.png}
            \includegraphics[height=0.25\textwidth]{lectures/slides_tex/GoogleColabGithub.png}
        \end{figure}
